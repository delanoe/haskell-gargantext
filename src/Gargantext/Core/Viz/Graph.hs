...
import Gargantext.API.Ngrams.Types (NgramsTerm, NgramsRepoElement)
...
graphV3ToGraph (GraphV3 links nodes) = Graph (map nodeV32node nodes) (zipWith linkV32edge [1..] links) Nothing Nothing
  where
